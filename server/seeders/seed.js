...
async function seed() {
  try {
    ...
    const roomData = [
      // Standard Rooms
      { roomNumber: '101', roomType: 'Standard', price: 3500, capacity: 2, discountPercent: 0, amenities: ['WiFi', 'AC', 'TV', 'Mini Fridge', 'En-suite Bathroom'], images: roomImages.standard, description: 'A cozy and comfortable standard room featuring modern furnishings, a plush queen-size bed, and all essential amenities for a relaxing stay. Perfect for solo travellers or couples on a budget-friendly getaway.' },
      { roomNumber: '102', roomType: 'Standard', price: 3500, capacity: 2, discountPercent: 10, amenities: ['WiFi', 'AC', 'TV', 'Mini Fridge', 'En-suite Bathroom'], images: roomImages.standard, description: 'A cozy and comfortable standard room featuring modern furnishings, a plush queen-size bed, and all essential amenities for a relaxing stay. Perfect for solo travellers or couples on a budget-friendly getaway.' },
      ...
      // Deluxe Rooms
      { roomNumber: '201', roomType: 'Deluxe', price: 5500, capacity: 3, discountPercent: 0, amenities: ['WiFi', 'AC', 'Smart TV', 'Mini Bar', 'Bathtub', 'Work Desk', 'Room Service'], images: roomImages.deluxe, description: 'Step into refined comfort with our Deluxe rooms. Featuring elegant decor, a king-size bed, premium toiletries, and a dedicated work desk — ideal for business travellers seeking space and luxury in equal measure.' },
      { roomNumber: '202', roomType: 'Deluxe', price: 5500, capacity: 3, discountPercent: 15, amenities: ['WiFi', 'AC', 'Smart TV', 'Mini Bar', 'Bathtub', 'Work Desk', 'Room Service'], images: roomImages.deluxe, description: 'Step into refined comfort with our Deluxe rooms. Featuring elegant decor, a king-size bed, premium toiletries, and a dedicated work desk — ideal for business travellers seeking space and luxury.' },
      { roomNumber: '203', roomType: 'Deluxe', price: 5500, capacity: 3, discountPercent: 0, amenities: ['WiFi', 'AC', 'Smart TV', 'Mini Bar', 'Bathtub', 'Work Desk', 'Room Service'], images: roomImages.deluxe, description: 'Step into refined comfort with our Deluxe rooms. Featuring elegant decor, a king-size bed, premium toiletries, and a dedicated work desk.' },
      // Executive Suites
      { roomNumber: '301', roomType: 'Executive Suite', price: 8500, capacity: 4, discountPercent: 0, amenities: ['WiFi', 'AC', 'Smart TV', 'Full Bar', 'Jacuzzi', 'Living Room', 'Kitchenette', 'Butler Service', 'Balcony'], images: roomImages.suite, description: 'Experience unmatched luxury in our Executive Suites. A sprawling living area, separate bedroom, jacuzzi, and personalised butler service make this the ultimate indulgence — perfect for special occasions and extended stays.' },
      { roomNumber: '302', roomType: 'Executive Suite', price: 8500, capacity: 4, discountPercent: 20, amenities: ['WiFi', 'AC', 'Smart TV', 'Full Bar', 'Jacuzzi', 'Living Room', 'Kitchenette', 'Butler Service', 'Balcony'], images: roomImages.suite, description: 'Experience unmatched luxury in our Executive Suites. A sprawling living area, separate bedroom, jacuzzi, and personalised butler service make this the ultimate indulgence.' },
    ...
    console.log('👤 Demo users: ravi@example.com / Guest@123');
    console.log(`🏨 Hotel: ${hotel.name}`);
    console.log(`🛏  Rooms: ${rooms.length} rooms (3 types)`);
